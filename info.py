...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'db1')
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://graph.org/file/03a2199fc52d292cc2422.jpg")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'A1pher_supportz')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001936319511')).split()]
